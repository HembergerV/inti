  		...
  		<div class="modal-dialog modal-dialog-centered" role="document">
    		<div class="modal-content card-success card-outline">
      			<div class="modal-header">
        			<h5 class="modal-title" id="exampleModalCenterTitle">Agregar Sector</h5>
    				...
    				<form role="form">
            			<div class="form-group">
              				...
              				<select class="form-control">
                				...
                				<option value="1">Pimpinela</option>
              				</select>
            			</div>
            			<div class="form-row">
              				<div class="col-md-12 mb-3">
                				<label>Ingrese un sector</label>
                				<input type="email" class="form-control" id="validationCustom03" placeholder="Ingrese aqui el sector" required>
              				</div>
            			</div>
          			</form>
