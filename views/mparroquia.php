  		...
  		<div class="modal-dialog modal-dialog-centered" role="document">
    		<div class="modal-content card-success card-outline">
      			<div class="modal-header">
        			<h5 class="modal-title" id="exampleModalCenterTitle">Agregar Ciudad</h5>
    				...
    				<form role="form">
            			...
            			<div class="form-row">
              				<div class="col-md-12 mb-3">
                				<label>Ingrese una Parroquia</label>
                				<input type="email" class="form-control" id="validationCustom03" placeholder="Ingrese aqui la parroquia" required>
              				</div>
            			</div>
          			</form>
