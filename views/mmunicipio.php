    ...
    <div class="content-wrapper">
	    ...
	    <section class="content-header">
	      <div class="container-fluid">
	        <div class="row mb-2">
	          <div class="col-sm-6">
	            <h1>Maestro Municiopio</h1>
	          </div>
	          <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              <li class="breadcrumb-item">Maestro</li>
	              <li class="breadcrumb-item active">Municiopio</li>
	            </ol>
	          </div>
	        </div>
	      </div><!-- /.container-fluid -->
	          ...
	          <div class="col-md-8 offset-md-2">
	            <div class="card card-success card-outline">
	              <div class="card-header">
	                <h3 class="card-title">Municiopio</h3>
	              </div>
	              <!-- /.card-header -->
	              <div class="card-body">
  		...
  		<div class="modal-dialog modal-dialog-centered" role="document">
    		<div class="modal-content card-success card-outline">
      			<div class="modal-header">
        			<h5 class="modal-title" id="exampleModalCenterTitle">Agregar Municipio</h5>
    				...
    				<form role="form">
            			<div class="form-group">
              				...
              				<select class="form-control">
                				...
                				<option value="1">Paez</option>
              				</select>
            			</div>
            			<div class="form-row">
              				<div class="col-md-12 mb-3">
                				<label>Ingrese un Municipio</label>
                				<input type="email" class="form-control" id="validationCustom03" placeholder="Ingrese aqui el Municipio" required>
              				</div>
            			</div>
          			</form>
