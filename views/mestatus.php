	          ...
	          <div class="col-md-10 offset-md-1">
	            <div class="card card-success card-outline">
	              <div class="card-header">
	                <h3 class="card-title">Maestro Estatus</h3>
	              </div>
	              <!-- /.card-header -->
	              <div class="card-body">
	                <table class="table table-bordered">
	                  ...
	                  <tr>
	                    ...
	                    <td>Pendiente</td>
	                    <td>
	                      La solicitud del tramite esta en lista para ser revisado.
	                    </td>
	                    <td>
  		...
  		<div class="modal-dialog modal-dialog-centered" role="document">
    		<div class="modal-content card-success card-outline">
      			<div class="modal-header">
        			<h5 class="modal-title" id="exampleModalCenterTitle">Agregar Estatus</h5>
      			...
      			<div class="modal-body">
    				<form role="form">
              					...
              					<div class="col-md-12 mb-3">
                					...
                					<textarea class="form-control" placeholder="Ingrese la Descripcion del Estatus" min-height="50" maxlength="20"></textarea>
              					</div>
              					<div class="col-md-12 mb-3">
